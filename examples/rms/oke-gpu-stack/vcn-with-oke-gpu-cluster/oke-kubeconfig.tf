...
locals {
  endpoint_port   = 6443
  public_endpoint = try(lookup(one(module.oke[*].cluster_endpoints), "public_endpoint", null), null)
  #   private_endpoint = try(lookup(one(module.oke[*].cluster_endpoints), "private_endpoint", null), null)
